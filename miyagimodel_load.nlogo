...
to setup
  ...
  set timeunit 0
  set realtime timeunit + 14 * 3600 + 46 * 60  ;;earthquake occur at 14:46
...
to go
 ...
 ;; ]
  ...
  set timeunit timeunit + 1
  set realtime realtime + 1
  set hours (floor (realtime / 3600))
  set minutes floor ((realtime mod 3600) / 60)
  set seconds timeunit mod 60
  set zerominutes "00"
  set zeroseconds "00"
  ifelse minutes < 10 [set zerominutes (word "0" minutes)][set zerominutes (word minutes)]
